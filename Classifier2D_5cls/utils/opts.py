...
parser.add_argument('--image_level_labels_csv', default="", type=str, help='image_level_labels_csv')
parser.add_argument('--organ_info_csv', default="", type=str, help='organ_info_csv')
...
parser.add_argument('--add_neg_in_pos', default=False, action="store_true")
parser.add_argument('--hu_min', default=-150.0, type=float, help='hu_min')
parser.add_argument('--hu_max', default=250.0, type=float, help='hu_max')
parser.add_argument('--time_step', default=16, type=int, help='time_step')
parser.add_argument('--shuffle_dcm', default=False, action="store_true")
...
parser.add_argument('--output_pt', default='', type=str, help = "output_pt path")
